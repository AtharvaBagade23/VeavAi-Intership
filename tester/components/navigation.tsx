...
export function Navigation({ activeTab, setActiveTab }: NavigationProps) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-black/10 dark:border-white/10 bg-white/80 dark:bg-gray-950/80 backdrop-blur-md backdrop-saturate-150 supports-[backdrop-filter]:bg-white/80">
